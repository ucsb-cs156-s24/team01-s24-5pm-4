...
public class TidesController {
    ...
    public ResponseEntity<String> getTides(
        @Parameter(name="beginDate", description="beginDate in format yyyymmdd", example="beginDate in format yyyymmdd") @RequestParam String beginDate,
        @Parameter(name="endDate", description="endDate in format yyyymmdd", example="endDate in format yyyymmdd") @RequestParam String endDate,
        @Parameter(name="station", description="station, e.g. 9411340 for Santa Barbara", example="station, e.g. 9411340 for Santa Barbara") @RequestParam String station
